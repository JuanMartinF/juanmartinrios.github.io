...
# Rutas de entrada
catalogo_path = "catalogo_de_cuadrosB.csv"
template_path = "html/b01.html"
...
for _, row in df.iterrows():
    ...
    if existing_html == 'no':
        ...
        html = html.replace("Vórtice 1", nombre)
        html = html.replace("Vórtice 1", nombre)
        html = html.replace("4076,8", str(precio))
...
print("Archivos generados en la carpeta 'proyectos/proyectoB/html'")
